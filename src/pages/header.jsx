    ...
    return (
        <div id="me" className="bg-bg min-h-screen flex flex-col justify-center items-center py-10 bg-[url('/patterns/noisy.webp')] object-cover ">
            ...
            <div className="relative flex gap-4 mt-6 ">
                <Link className="  hover:shadow-[0_0_40px_rgba(147,235,255,0.4)] transition-all border-[#fff] group   rounded-full  border-4  duration-500 p-2 flex items-center justify-center" href={'/resume.pdf'} target="_blank"><File  className="stroke-[#fff] " size={30}/></Link>
                <Link className="  hover:shadow-[0_0_40px_rgba(147,235,255,0.4)] transition-all border-[#fff] group   rounded-full  border-4  duration-500 p-2 flex items-center justify-center" href={'mailto:job.elfatimi@gmail.com'} target="_blank"><Mail  className="stroke-[#fff] " size={30}/></Link>
                <Link className="  hover:shadow-[0_0_40px_rgba(147,235,255,0.4)] transition-all border-[#fff] group   rounded-full  border-4  duration-500 p-2 flex items-center justify-center" href={'https://wa.me/+212602314804'} target="_blank"><MessageSquare  className="stroke-[#fff] " size={30}/></Link>
                <Link className="  hover:shadow-[0_0_40px_rgba(147,235,255,0.4)] transition-all border-[#fff] group   rounded-full  border-4  duration-500 p-2 flex items-center justify-center" href={'https://www.linkedin.com/in/salaheddine-elfatimi-b160ab252/'} target="_blank"><Linkedin  className="stroke-[#fff] " size={30}/></Link>    
                <Link className="  hover:shadow-[0_0_40px_rgba(147,235,255,0.4)] transition-all border-[#fff] group   rounded-full  border-4  duration-500 p-2 flex items-center justify-center" href={'https://www.instagram.com/salaheddine_elfatimi/'} target="_blank"><Instagram  className="stroke-[#fff] " size={30} /></Link>
            </div>
